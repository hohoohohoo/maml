...
DATASET_CONFIGS = {
    'original_agnostic': {
        ...
        'exclude_patterns': [],
        'output_suffix': 'topology_agnostic_data_reduced',
    ...
    'original_intra': {
        ...
        'folder_pattern': 'TSMC_??_*',
        'exclude_patterns': [],
        'output_suffix': 'intratopology_data',
        'topology_type': 'intra',
    ...
    'nor_nand': {
        ...
        'exclude_patterns': [],
        'output_suffix': 'topology_agnostic_data2',
        'topology_type': 'agnostic',
        'test_cell_types': []  # No test cells, all for training
    },
    'seq': {
        'name': 'Sequential Cells (TSMC_*seq_*)',
        'folder_pattern': 'TSMC_*seq*',
        'exclude_patterns': [],
        'output_suffix': 'topology_agnostic_data_Seq',
        'topology_type': 'agnostic',
        'test_cell_types': ["DFCNQD1BWP30P140", "SDFSNQD0BWP30P140"]
    }
}
...
""")
    ...
    parser.add_argument('-t', '--dataset-type', type=str,
                       choices=['original_agnostic', 'original_intra', 'nor_nand', 'seq'],
                       help='Dataset type: original_agnostic, original_intra, nor_nand, or seq')
...
def build_command(dataset_type, delay_type, train_only=False):
    ...
    cmd.extend(['--data-dirs', TSMC_DATA_DIR])
