...
OUTPUT_DIR="/home/tkdgn2907/Deepsets_test/MAML/Projects/dataset_tsmc_processed/topology_agnostic_data2"
...
TEST_CELL_TYPES=(" ")  # Can be modified to specific cell types if needed
...
# Find all TSMC folders with '2' suffix (TSMC_SS2_, TSMC_TT2_, TSMC_FF2_, TSMC_SF2_, TSMC_FS2_)
TSMC_FOLDERS=$(find "$DATA_DIR" -maxdepth 1 -type d -name "TSMC_*2_*" | sort)
