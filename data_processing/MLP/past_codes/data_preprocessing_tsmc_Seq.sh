...
OUTPUT_DIR="/home/tkdgn2907/Deepsets_test/MAML/Projects/dataset_tsmc_processed/topology_agnostic_data_Seq"
DATA_DIR="/home/tkdgn2907/Deepsets_test/MAML/Projects/dataset_tsmc"  # TSMC data directory
...
TEST_CELL_TYPES=("DFCNQD1BWP30P140" "SDFSNQD0BWP30P140")  # Can be modified to specific cell types if needed
...
# Find all TSMC Seq folders only (not other TSMC_ folders)
TSMC_FOLDERS=$(find "$DATA_DIR" -maxdepth 1 -type d -name "TSMC_Seq*" | sort)
