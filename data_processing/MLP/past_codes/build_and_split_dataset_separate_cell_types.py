    ...
    for target_cell_type in target_cell_types:
        ...
        if all_test_inputs and all_test_outputs:
            ...
            try:
                ...
                test_input_path = f"{output_dir}/cell_{target_cell_type}_test_input.pth"
                test_output_path = f"{output_dir}/cell_{target_cell_type}_test_output.pth"
...
def create_shared_train_set(folder_paths, abc_param_lists, exclude_cell_types, output_dir):
    ...
    if all_train_inputs and all_train_outputs:
        ...
        train_input_path = f"{output_dir}/cell_intratopology_train_input.pth"
        train_output_path = f"{output_dir}/cell_intratopology_train_output.pth"
