#!/bin/bash
# GNN Topology Validation Sweep for ASAP7 Process Dataset with Parasitic Cap
# Runs validation across experiment types (intra_topology/topology_agnostic) and architectures
# Uses ASAP7 Process dataset with 12D node features (7 base + 4 process params + parasitic_cap)
...
if [ $# -lt 1 ]; then
    ...
    echo ""
    echo "Example:"
    echo "  $0 json_configs/validation_gnn_asap7_process_parasitic_sweep_config.json"
    echo "  $0 json_configs/validation_gnn_asap7_process_parasitic_sweep_config.json --dry-run"
    echo ""
    echo "Note: Requires ASAP7 Process Parasitic GNN dataset to be pre-generated."
    echo "      Dataset: dataset_all/dataset_temp_process/with_parasitic_cap/"
    echo ""
...
echo "=========================================="
echo "GNN Topology Validation - ASAP7 Process Parasitic Dataset Sweep"
echo "=========================================="
...
echo "Starting ASAP7 Process Parasitic topology validation sweep..."
echo "=========================================="
echo ""
...
" | while read EXP CONV_DIM CONV_LAYERS FC_DIM FC_LAYERS; do
    ...
    # Build command - use ASAP7 Parasitic version
    CMD="python -u ASAP7_GCN_topology_validation_parasitic.py"
...
echo ""
echo "=========================================="
echo "ASAP7 Process Parasitic Topology Validation Sweep Complete"
echo "=========================================="
