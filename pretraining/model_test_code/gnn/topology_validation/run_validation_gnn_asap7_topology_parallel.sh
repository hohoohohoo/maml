#!/bin/bash
# GNN Topology Validation - Parallel Execution by Cell
...
if [ $# -lt 1 ]; then
    ...
    echo ""
    echo "Example:"
    echo "  $0 json_configs/validation_gnn_asap7_topology_sweep_config.json --gpus 4,5,6,7"
    echo "  $0 json_configs/validation_gnn_asap7_topology_sweep_config.json --gpus 4,5,6,7 --jobs-per-gpu 2"
...
echo "=========================================="
echo "GNN Topology Validation - PARALLEL MODE"
echo "=========================================="
...
#INTRA_TOPOLOGY_CELLS="NAND3x2"
TOPOLOGY_AGNOSTIC_CELLS="AO21x1 FAx1 OAI22x1"
#TOPOLOGY_AGNOSTIC_CELLS="FAx1 HAx1 XNOR2x2 XOR2x2 AO21x1 AO32x1 OAI22x1"
# Create log directory
LOG_DIR="$SCRIPT_DIR/parallel_logs/$(date +%Y%m%d_%H%M%S)"
mkdir -p "$LOG_DIR"
