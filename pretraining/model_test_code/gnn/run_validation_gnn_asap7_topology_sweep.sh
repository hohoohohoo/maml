#!/bin/bash
# GNN Topology Validation Sweep for ASAP7 Process Dataset
# Runs validation across experiment types (intra_topology/topology_agnostic) and architectures
# Uses ASAP7 Process dataset with 11D node features (7 base + 4 process params)
...
if [ $# -lt 1 ]; then
    ...
    echo ""
    echo "Example:"
    echo "  $0 json_configs/validation_gnn_asap7_topology_sweep_config.json"
...
echo "=========================================="
echo "GNN Topology Validation - ASAP7 Process Dataset Sweep"
echo "=========================================="
...
echo "Starting ASAP7 Process topology validation sweep..."
echo "=========================================="
echo ""
...
" | while read EXP CONV_DIM CONV_LAYERS FC_DIM FC_LAYERS; do
    ...
    # Build command - use ASAP7 version
...
echo ""
echo "=========================================="
echo "ASAP7 Process Topology Validation Sweep Complete"
echo "=========================================="
