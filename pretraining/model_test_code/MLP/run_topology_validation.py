...
def build_maml_command(config_id, cells, params):
    ...
    script_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'topology_validation', 'MAML_topology_validation.py')
...
def build_mlp_command(config_id, cells, params):
    ...
    script_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'topology_validation', 'MLP_topology_validation.py')
