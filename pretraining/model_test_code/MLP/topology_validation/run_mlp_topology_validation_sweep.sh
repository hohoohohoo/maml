...
if [ $# -lt 1 ]; then
    ...
    echo ""
    echo "Example:"
    echo "  $0 configs/mlp_topology_validation_sweep.json"
    echo "  $0 configs/mlp_topology_validation_sweep.json --dry-run"
    echo "  $0 configs/mlp_topology_validation_sweep.json --no-commit"
    exit 1
fi
