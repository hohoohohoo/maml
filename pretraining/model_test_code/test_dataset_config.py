...
TEST_CONFIGS = {
    0: {
        ...
        # Model paths
        'maml_model_path': lambda data_type, innerdiv, meta, inner: f"/home/tkdgn2907/Deepsets_test/MAML/Projects/pretrained_models/checkpoints/taskdivide_all_checkpoints/{data_type}_innerdiv{innerdiv}_meta{meta}_intratopology_519traintask_full1DMAML_weights_3hidden_(40)_300000_inner{inner}_upgraded.pth",
        'mlp_model_path': lambda data_type, model_type, num_iterations: f"/home/tkdgn2907/Deepsets_test/MAML/Projects/pretraining/model_pretraining_code/MLP_pretrained_model/pretrained_asap7_all_intratopology_{data_type}_test5_{model_type}_{num_iterations}.pth",
    },
    ...
    1: {
        ...
        # Default settings
        'default_cells': ['FAx1', 'HAx2', 'HAx3', 'HA1x1'],
        'default_gpu': '0',
        'default_meta': 32,
        'default_data_type': 'transition',
        ...
        # Model paths
        'maml_model_path': lambda data_type, innerdiv, meta, inner: f"/home/tkdgn2907/Deepsets_test/MAML/Projects/pretrained_models/checkpoints/taskdivide_all_checkpoints/{data_type}_innerdiv{innerdiv}_meta{meta}_topology_agnostic_519traintask_full1DMAML_weights_3hidden_(40)_600000_inner{inner}_upgraded.pth",
        'mlp_model_path': lambda data_type, model_type, num_iterations: f"/home/tkdgn2907/Deepsets_test/MAML/Projects/pretraining/model_pretraining_code/MLP_pretrained_model/pretrained_asap7_all_topology_agnostic_{data_type}_test5_{model_type}_{num_iterations}.pth",
    },
    ...
    2: {
        ...
        # Model paths
        'maml_model_path': lambda data_type, innerdiv, meta, inner: f"/home/tkdgn2907/Deepsets_test/MAML/Projects/pretrained_models/taskdivide_all/{data_type}_innerdiv{innerdiv}_meta{meta}_intra_topology_519traintask_full1DMAML_weights_3hidden_(40)_300000_inner{inner}_upgraded_tsmc_merged.pth",
        'mlp_model_path': lambda data_type, model_type, num_iterations: f"/home/tkdgn2907/Deepsets_test/MAML/Projects/pretraining/model_pretraining_code/MLP_pretrained_model/pretrained_tsmc_all_intratopology_{data_type}_test5_{model_type}_{num_iterations}.pth",
    },
    ...
    3: {
        ...
        # Model paths
        'maml_model_path': lambda data_type, innerdiv, meta, inner: f"/home/tkdgn2907/Deepsets_test/MAML/Projects/pretrained_models/taskdivide_all/{data_type}_innerdiv{innerdiv}_meta{meta}_topology_agnostic_519traintask_full1DMAML_weights_3hidden_(40)_300000_inner{inner}_upgraded_tsmc.pth",
        'mlp_model_path': lambda data_type, model_type, num_iterations: f"/home/tkdgn2907/Deepsets_test/MAML/Projects/pretraining/model_pretraining_code/MLP_pretrained_model/pretrained_tsmc_all_topology_agnostic_{data_type}_test5_{model_type}_{num_iterations}.pth",
    }
}
...
def get_maml_model_path(config_id, data_type='transition', innerdiv=100, meta=None, inner=1, custom_path=None):
    """
    Get MAML model path
    ...
    return config['maml_model_path'](data_type, innerdiv, meta, inner)
