#!/bin/bash
# Direct shell script to run MAML 2-D V×T MLP training from JSON config
# This script parses JSON using Python and directly executes maml_mlp_training_2d.py
# Use dataset_config 4 (TSMC intra 2-D) or 5 (TSMC agnostic 2-D).
...
BASE_CMD="python -u maml_mlp_training_2d.py"
BASE_ARGS=""
