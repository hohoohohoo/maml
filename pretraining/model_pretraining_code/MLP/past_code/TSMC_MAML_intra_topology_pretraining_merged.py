...
def main():
    ...
    # 파일명 패턴: cell_innerdiv100_meta32_intra_topology_519traintask_full1DMAML_weights_3hidden_(40)_100000_inner1_upgraded_tsmc_merged.pth
    # 또는: cell_innerdiv100_meta32_intra_topology_519traintask_full1DMAML_weights_3hidden_40_100000_inner1_upgraded_tsmc_merged.pth
...
def find_pretrained_model(model_dir, layer_length, inner, innerdiv=100, meta=32, data_type='cell'):
    ...
    pattern1 = f"{data_type}_innerdiv{innerdiv}_meta{meta}_intra_topology_519traintask_full1DMAML_weights_3hidden_({layer_length})_*_inner{inner}_upgraded_tsmc_merged.pth"
    pattern2 = f"{data_type}_innerdiv{innerdiv}_meta{meta}_intra_topology_519traintask_full1DMAML_weights_3hidden_{layer_length}_*_inner{inner}_upgraded_tsmc_merged.pth"
...
def main():
    ...
    print(f"\n🚀 Processing TSMC intra topology {data_type} dataset - MERGED")
    ...
    # Dataset 1: intra_topology_data
    data_dir1 = "/home/tkdgn2907/Deepsets_test/MAML/Projects/dataset_all/dataset_tsmc_processed/intra_topology_data/"
    print(f"📂 Loading dataset 1 from: {data_dir1}")
    test_data_input_1 = torch.load(f"{data_dir1}/tsmc_intra_topology_train_input_{data_type}.pth")
    test_data_output_1_1 = torch.load(f"{data_dir1}/tsmc_intra_topology_train_output_{data_type}.pth")
    ...
    for chunk in range(1, num_chunks + 1):
        ...
        checkpoint_path = f"{checkpoint_dir}/{data_type}_innerdiv{innerdiv}_meta{meta}_intra_topology_519traintask_full1DMAML_weights_3hidden_({layer_length})_{current_iteration}_inner{inner}_upgraded_tsmc_adding_NAND_NOR.pth"
    ...
    final_model_path = f"{pretrained_models_dir}/{data_type}_innerdiv{innerdiv}_meta{meta}_intra_topology_519traintask_full1DMAML_weights_3hidden_({layer_length})_{final_iteration}_inner{inner}_upgraded_tsmc_adding_NAND_NOR.pth"
