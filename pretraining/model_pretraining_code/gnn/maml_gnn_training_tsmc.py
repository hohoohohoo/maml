...
def train_single_config(folder_name, args):
    ...
    for idx, (conv_hidden_dim, num_conv_layers, fc_hidden_dim, num_fc_layers) in enumerate(arch_combinations, 1):
        ...
        for chunk in range(num_chunks):
            ...
            checkpoint_path = f"{checkpoint_dir}/gnn_maml_{folder_name}_{data_type}_{graph_mode}_innerdiv{innerdiv}_meta{tasks_per_meta_batch}_iter{iterations_completed}_inner{inner_steps}{arch_suffix}.pth"
        ...
        final_model_path = f"{final_model_dir}/gnn_maml_{folder_name}_{data_type}_{graph_mode}_innerdiv{innerdiv}_meta{tasks_per_meta_batch}_iter{total_iterations}_inner{inner_steps}{arch_suffix}.pth"
