...
# Default dataset path (norm2 version - modified normalization)
DEFAULT_DATASET_DIR = "/home/tkdgn2907/Deepsets_test/MAML/Projects/dataset_all/dataset_TSMC_GNN_unified_norm2"
...
def train_single_config(args):
    ...
    train_file = f"train_{data_type}_{graph_mode}{voltage_suffix}.pth"
    ...
    # Checkpoint directories (include voltage_mode suffix for vdd_only) - norm2 version
    checkpoint_dir = f"../../../pretrained_models/gnn_maml_tsmc_process_norm2_checkpoints{voltage_suffix}"
    final_model_dir = f"../../../pretrained_models/gnn_maml_tsmc_process_norm2_final{voltage_suffix}"
