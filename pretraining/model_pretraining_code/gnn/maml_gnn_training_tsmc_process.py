...
def train_single_config(args):
    ...
    checkpoint_dir = "../../../pretrained_models/gnn_maml_tsmc_process_checkpoints"
    final_model_dir = "../../../pretrained_models/gnn_maml_tsmc_process_final"
    ...
    for idx, (conv_hidden_dim, num_conv_layers, fc_hidden_dim, num_fc_layers) in enumerate(arch_combinations, 1):
        ...
        for chunk in range(num_chunks):
            ...
            checkpoint_path = f"{checkpoint_dir}/gnn_maml_tsmc_process_{data_type}_{graph_mode}_innerdiv{innerdiv}_meta{tasks_per_meta_batch}_iter{iterations_completed}_inner{inner_steps}{arch_suffix}.pth"
        ...
        # Save final model
        arch_suffix = f"_conv{conv_hidden_dim}x{num_conv_layers}_fc{fc_hidden_dim}x{num_fc_layers}"
        final_model_path = f"{final_model_dir}/gnn_maml_tsmc_process_{data_type}_{graph_mode}_innerdiv{innerdiv}_meta{tasks_per_meta_batch}_iter{total_iterations}_inner{inner_steps}{arch_suffix}.pth"
