...
def main():
    ...
    """
    total_iterations = 100000  # Smaller for testing
    chunk_size = 10000
    ...
    for chunk in range(num_chunks):
        ...
        checkpoint_path = f"{checkpoint_dir}/gnn_maml_{process}_{type}_chunk_{chunk+1}_K{inner_step}.pth"
    ...
    final_model_path = f"{final_model_dir}/gnn_maml_{process}_{type}_final_K{inner_step}.pth"
