...
def load_and_preprocess_data(data_type='cell', device='cuda'):
    ...
    test_data_input = torch.load(f"/home/tkdgn2907/Deepsets_test/MAML/Projects/dataset_all/unified_invbuf/merged_invbuf_input_{data_type}.pth")
    test_data_output_1 = torch.load(f"/home/tkdgn2907/Deepsets_test/MAML/Projects/dataset_all/unified_invbuf/merged_invbuf_output_{data_type}.pth")
...
def train_mlp1_model(num_iterations=100000, data_type='cell', learning_rate=1e-4, model_type='mlp', device='cuda'):
    ...
    checkpoint_dir = f'/home/tkdgn2907/Deepsets_test/MAML/Projects/pretraining/model_pretraining_code/MLP_pretrained_model/checkpoints_topology_agnostic_{data_type}_{model_type}_{num_iterations}'
    mlp1_train_loss = mlp1.loop(checkpoint_dir=checkpoint_dir)

    # Save model using utility function
    model_save_path = f'/home/tkdgn2907/Deepsets_test/MAML/Projects/pretraining/model_pretraining_code/MLP_pretrained_model/pretrained_mlp1_topology_agnostic_{data_type}_{model_type}_{num_iterations}.pth'
...
def main():
    ...
    parser = argparse.ArgumentParser(description='MLP Pretraining - ASAP7 Topology Agnostic')
    ...
    parser.add_argument('--num_iterations', type=int, default=3000000,
                        help='Number of training iterations (default: 3000000)')
    parser.add_argument('--learning_rate', type=float, default=1e-4,
                        help='Learning rate for Adam optimizer (default: 1e-4)')
    parser.add_argument('--model_type', type=str, default='mlp', choices=['aadam', 'mlp'],
                        help='Model type: aadam (hidden=256) or mlp (hidden=40) (default: mlp)')
    ...
    print(f"\n🚀 Starting MLP1 training on ASAP7 topology agnostic {data_type} dataset")
